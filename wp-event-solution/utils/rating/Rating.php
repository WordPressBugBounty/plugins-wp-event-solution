...
namespace Eventin\Utils\Rating;
...
class Rating
{
    ...
    public function update_settings() {
        ...
        set_transient( $this->text_domain . '_rating_settings', 'no', 12 * HOUR_IN_SECONDS );
    }
