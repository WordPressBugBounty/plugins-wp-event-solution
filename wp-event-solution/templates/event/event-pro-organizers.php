...
<div class="etn-event-organizers etn-organizer-style-1">
    <h4 class="etn-title">
        <?php  
            $event_organizers_title = apply_filters( 'etn_event_organizers_title', esc_html__("Organizer:",  'eventin' ) );
            ...
            foreach ($data as $value) { 
                ...
                <div class="etn-organaizer-item">
                    ...
                    if ( ! empty($etn_speaker_company_logo) ) { 
                        ...
                        ?>
                        <div class="etn-organizer-logo">
                            <img src="<?php echo esc_url( $etn_company_logo ); ?>" loading="lazy" decoding="async" >
                        </div>
                    <?php
                    } ?>
