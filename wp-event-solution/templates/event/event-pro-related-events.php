...
$data                    = \Etn\Utils\Helper::post_data_query( 'etn', $related_events_per_page, 'DESC', $etn_term_ids, "etn_tags", null, array( $single_event_id ), null, null, 'post_date', 'upcoming' );
			...
			foreach ( $data as $value ) {
                ...
                <div class="etn-event-item">
                    ...
                    <div class="etn-event-content">
                        <h4 class="etn-title etn-event-title">
