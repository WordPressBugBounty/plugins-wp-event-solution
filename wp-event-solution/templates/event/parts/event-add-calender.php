    ...
    <div class="container">
        <div class="etn-add-calender">
            ...
            $yahoo_url = add_query_arg( array(
                ...
                'desc'   => $plain_desc,
                'in_loc' => is_array( $location ) ? '' : $location,
            ), 'https://calendar.yahoo.com/' );

            $outlook_url = add_query_arg( array(
                'rru'     => 'addevent',
                'enddt'   => $outlook_event_end,
                'startdt' => $outlook_event_start,
                'allday'  => 'false',
                'subject' => $title,
                'body'    => $plain_desc,
            ...
            <ul id="etn_add_calender_links" class="etn-calender-list">
                <li>
                    <a href="<?php echo esc_url( $google_url ); ?>" rel="noopener noreferrer nofollow" target="_blank" class="etn-add-to-calender">
                ...
                <li>
                    <a href="<?php echo esc_url( $yahoo_url ); ?>" rel="noopener noreferrer nofollow" target="_blank" class="etn-add-to-calender">
                        <div class="calender-icon">
                ...
                <li>
                    ...
                    ?>
                    <a href="<?php echo esc_url( $ics_url ); ?>" class='etn-add-to-calender'>
                        <div class="calender-icon">
                ...
                <li>
                    <a href="<?php echo esc_url( $outlook_url ); ?>" rel="noopener noreferrer nofollow" target="_blank" class="etn-add-to-calender"> 
                        <div class="calender-icon">
