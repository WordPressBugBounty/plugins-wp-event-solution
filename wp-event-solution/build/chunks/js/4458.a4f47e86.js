"use strict";(globalThis.webpackChunkwp_event_solution||=[]).push([[4458],{2959(e,t,n){var a=n(51609),l=n(86087),i=n(27723),r=n(17437),s=n(50400),d=n(38181),o=n(54861),c=n(60742),m=n(87959),u=n(51643),p=n(36492),_=n(67313),v=n(59499),g=n(85102),f=n(85641),x=n(74353),E=n.n(x),h=n(5019),b=n(10012),A=n(6836),y=n(27154);const{Text:k}=_.A;function q({value:e,onChange:t}){const[n,d]=(0,l.useState)(null);(0,l.useEffect)(()=>{if(!e)return void d(null);if(n?.id===e)return;const t=window?.wp?.media;if(!t)return;const a=t.attachment(e);a.fetch().then(()=>d(a.toJSON()))},[e]);const o=()=>{const e=window?.wp?.media;if(!e)return void m.Ay.error((0,i.__)("WordPress media library is not available on this page.","eventin"));const n=e({title:(0,i.__)("Select File","eventin"),button:{text:(0,i.__)("Use this file","eventin")},library:{type:["image","application/pdf"]},multiple:!1});n.on("select",()=>{const e=n.state().get("selection").first().toJSON();y.lb.includes(e.mime)?(d(e),t?.(e.id)):m.Ay.error((0,i.__)("Unsupported file type. Allowed: JPG, PNG, WEBP, PDF.","eventin"))}),n.open()},c=n?.mime?.startsWith("image/");return e?(0,a.createElement)("div",{className:"etn-media-picker",style:{display:"flex",alignItems:"center",gap:12,padding:8,border:"1px solid #e5e7eb",borderRadius:6,background:"#fafafa",flexWrap:"wrap"}},(0,a.createElement)(r.mL,{styles:r.AH`
