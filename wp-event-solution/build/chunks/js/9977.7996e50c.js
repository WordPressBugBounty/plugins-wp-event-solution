...
`;n.d(t,["B0",0,x,"HJ",0,b,"IL",0,m,"OI",0,h,"Us",0,y,"Wd",0,d,"XN",0,g,"_q",0,c,"cL",0,s,"eO",0,E,"eU",0,p,"iU",0,f,"s0",0,v,"ve",0,_,"xI",0,u])},9977(e,t,n){n.r(t);var a=n(51609),i=n(29491),r=n(47143),o=(n(27723),n(86087)),l=n(47767),s=n(5028),c=n(92805),d=n(85666),p=n(97455),m=n(59720),g=n(96796),v=n(40728),u=n(71322);const f=(0,r.withDispatch)((e,t,{select:n})=>{const a=e(s.EF);return{invalidateEventRecurringList:()=>{const{recurringParentId:e}=n(s.EF).getEventState();a.invalidateResolution("getEventRecurringList",[e])}}}),h=(0,r.withSelect)(e=>{const t=e(s.EF),{recurringParentId:n}=t.getEventState();return{eventRecurringList:t.getEventRecurringList(n),hasResolved:t.hasFinishedResolution("getEventRecurringList",[n])}}),E=(0,i.compose)([f,h])(function(e){const{invalidateEventRecurringList:t,eventRecurringList:n,hasResolved:i}=e,{recurring_events:f}=n||{},{id:h}=(0,l.g)(),{selectedRecurringEvents:E,recurringParentId:x,eventRecurringParams:_}=(0,r.useSelect)(e=>e(s.EF).getEventState()),{setEventState:b}=(0,r.useDispatch)(s.EF);(0,o.useEffect)(()=>{h&&Number(h)!==x&&b({recurringParentId:Number(h)})},[h]),(0,o.useEffect)(()=>{x&&t()},[x]);const y={selectedRowKeys:E,onChange:e=>{b({selectedRecurringEvents:e})}};return(0,a.createElement)(a.Fragment,null,(0,a.createElement)(c.A,null),(0,a.createElement)(p.ff,{className:"event-list-wrapper"},(0,a.createElement)("div",{className:"event-list-wrapper"},(0,a.createElement)(m.A,{invalidateEventList:t,selectedEventsKey:"selectedRecurringEvents",paramsKey:"eventRecurringParams",loadingKey:"eventRecurringActionLoading"}),(0,a.createElement)(d.A,{loading:!i,columns:g.Y,showPagination:!1,dataSource:f?.items||[],scroll:{x:1e3},total:f?.total_items||0,rowSelection:y,tableHeaderData:(0,a.createElement)(u.A,{data:n,id:h})}),(0,a.createElement)(v.A,{total:f?.total_items||0,currentPage:_?.paged||1,pageSize:_?.per_page||10,onPageChange:e=>{b({eventRecurringParams:{..._,paged:e}}),t()},onPageSizeChange:e=>{b({eventRecurringParams:{..._,per_page:parseInt(e),paged:1}}),t()}}))))});n.d(t,["default",0,E])},71322(e,t,n){var a=n(51609),i=n(69815),r=n(84976),o=n(27723),l=n(27154);const s=i.A.div`
