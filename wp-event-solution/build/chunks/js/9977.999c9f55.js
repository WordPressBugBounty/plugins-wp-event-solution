...
`,c=(0,i.default)(o.A,{shouldForwardProp:e=>"isFiltered"!==e})`
...
`},9977(e,t,n){n.r(t),n.d(t,{default:()=>E});var a=n(51609),i=n(29491),r=n(47143),o=(n(27723),n(86087)),l=n(47767),s=n(5028),c=n(92805),d=n(85666),p=n(97455),m=n(59720),u=n(96796),g=n(40728),v=n(71322);const f=(0,r.withDispatch)((e,t,{select:n})=>{const a=e(s.EF);return{invalidateEventRecurringList:()=>{const{recurringParentId:e}=n(s.EF).getEventState();a.invalidateResolution("getEventRecurringList",[e])}}}),h=(0,r.withSelect)(e=>{const t=e(s.EF),{recurringParentId:n}=t.getEventState();return{eventRecurringList:t.getEventRecurringList(n),hasResolved:t.hasFinishedResolution("getEventRecurringList",[n])}}),E=(0,i.compose)([f,h])(function(e){const{invalidateEventRecurringList:t,eventRecurringList:n,hasResolved:i}=e,{recurring_events:f}=n||{},{id:h}=(0,l.useParams)(),{selectedRecurringEvents:E,recurringParentId:x,eventRecurringParams:_}=(0,r.useSelect)(e=>e(s.EF).getEventState()),{setEventState:b}=(0,r.useDispatch)(s.EF);(0,o.useEffect)(()=>{h&&Number(h)!==x&&b({recurringParentId:Number(h)})},[h]),(0,o.useEffect)(()=>{x&&t()},[x]);const y={selectedRowKeys:E,onChange:e=>{b({selectedRecurringEvents:e})}};return(0,a.createElement)(a.Fragment,null,(0,a.createElement)(c.A,null),(0,a.createElement)(p.ff,{className:"event-list-wrapper"},(0,a.createElement)("div",{className:"event-list-wrapper"},(0,a.createElement)(m.A,{invalidateEventList:t,selectedEventsKey:"selectedRecurringEvents",paramsKey:"eventRecurringParams",loadingKey:"eventRecurringActionLoading"}),(0,a.createElement)(d.A,{loading:!i,columns:u.Y,showPagination:!1,dataSource:f?.items||[],scroll:{x:1e3},total:f?.total_items||0,rowSelection:y,tableHeaderData:(0,a.createElement)(v.A,{data:n,id:h})}),(0,a.createElement)(g.A,{total:f?.total_items||0,currentPage:_?.paged||1,pageSize:_?.per_page||10,onPageChange:e=>{b({eventRecurringParams:{..._,paged:e}}),t()},onPageSizeChange:e=>{b({eventRecurringParams:{..._,per_page:parseInt(e),paged:1}}),t()}}))))})},71322(e,t,n){n.d(t,{A:()=>g});var a=n(51609),i=n(69815),r=n(84976),o=n(27723),l=n(27154);const s=i.default.div`
