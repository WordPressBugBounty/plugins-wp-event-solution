										...
										<div class="etn-col-lg-6">
											<div class="etn-field-wrap">
												...
												$event_list = [
																				...
																				Helper::get_option_range($event_list);
																				?>
																		</div>
																</div>
																<div class="etn-col-lg-6">
														...
														<div class="etn-row">
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				<?php
																				Helper::get_etn_taxonomy_ids('etn_category', 'event_cat_ids');
																				?>
																		</div>
																</div>
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				<?php
																				Helper::get_etn_taxonomy_ids('etn_tags', 'event_tag_ids');
																				?>
																		</div>
																</div>
														</div>
														...
														<div class="etn-row">
																...
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				Helper::get_option_range($orderby);
																				?>
																		</div>
																</div>
														</div>
														...
														<div class="etn-row">
																...
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				<?php Helper::get_option_style(4, 'etn_event_col', '', 'Column '); ?>
																		</div>
																</div>
														</div>
														<div class="etn-row">
															...
															<div class="etn-col-lg-6">
																<div class="etn-field-wrap">
																	...
																	Helper::get_option_range($show_end_date);
																	?>
																</div>
															</div>
														</div>
														<div class="etn-row">
															<div class="etn-col-lg-6">
																<div class="etn-field-wrap">
																		...
																		<?php Helper::get_show_hide('show_child_event'); ?>
																</div>
															</div>
															<div class="etn-col-lg-6">
																<div class="etn-field-wrap">
																	<h3><?php echo esc_html__('Show Recurring Parent Events', 'eventin'); ?></h3>
																	<?php Helper::get_show_hide_recurring('show_parent_event', 1 ); ?>
																</div>
															</div>
														</div>
														<div class="etn-row">
															<div class="etn-col-lg-6">
																<div class="etn-field-wrap">
																		...
																		<?php Helper::get_show_hide('show_event_location'); ?>
																</div>
															</div>
															<div class="etn-col-lg-6">
																<div class="etn-field-wrap">
																	<h3><?php echo esc_html__('Show Event Desc', 'eventin'); ?></h3>
																	<?php Helper::get_show_hide('etn_desc_show'); ?>
																</div>
															</div>
														</div>
														...
														<div class="etn-row">
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				<?php Helper::get_show_hide('show_desc'); ?>
																		</div>
																</div>
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
														...
														<div class="etn-row">
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				<h3><?php echo esc_html__('Select Category', 'eventin'); ?></h3>
																				<?php
																				Helper::get_etn_taxonomy_ids('etn_speaker_category', 'cat_id');
																				?>
																		</div>
																</div>
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				<?php Helper::get_option_style(4, 'etn_speaker_col', '', 'Column '); ?>
																		</div>
																</div>
														</div>
														...
														<div class="etn-row">
																<div class="etn-col-lg-6">
																		<div class="etn-field-wrap">
																				...
																				Helper::get_option_range($schedules, 'get_template get_schedule_template');
																				?>
																		</div>
																</div>
																<div class="etn-col-lg-6">
														...
														<div class="etn-row">
																<div class="etn-col-lg-12">
																		<div class="etn-field-wrap">
																				<h3><?php echo esc_html__('Select Schedule', 'eventin'); ?></h3>
																				<?php
																				Helper::get_posts_ids('etn-schedule', 'ids',' ');
																				?>
																		</div>
																</div>
													...
													<select  class="get_template etn-setting-input">
																		...
																		<div class="etn-col-lg-6">
																				<div class="etn-field-wrap">
																						...
																						<?php Helper::get_show_hide('link_only'); ?>
																				</div>
																		</div>
																</div>
																<div class="etn-row">
																		<div class="etn-col-lg-12">
																				<div class="etn-field-wrap">
																						...
																						<?php
																						Helper::get_posts_ids('etn','meeting_id', ' ');
																						?>
																				</div>
																		</div>
											...
											<div class="etn-row">
												...
												<div class="etn-col-lg-6">
													<div class="etn-field-wrap">
														<h3><?php echo esc_html__('Select Event', 'eventin'); ?></h3>
														<?php
														Helper::get_posts_ids('etn', 'event_id', ' ');
														?>
													</div>
												</div>
											</div>
