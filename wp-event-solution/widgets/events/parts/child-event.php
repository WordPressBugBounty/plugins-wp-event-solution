                                ...
                                <div class="etn-atend-btn">
                                    <?php
                                        ...
                                        if ($show_form_button === false) {
                                            ...
                                            ?>
                                            <a href="<?php echo esc_url(get_the_permalink($item->ID)); ?>" class="etn-btn etn-btn-border" title="<?php echo esc_attr(get_the_title($item->ID)); ?>"><?php echo esc_html__('Attend', 'eventin') ?> <i class="etn-icon etn-arrow-right"></i></a>
                                            <?php
                                        }
                                    ?>
                                </div>
